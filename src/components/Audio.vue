<template>
  <div>
    ...
    <el-button class="uploadgrade" v-if="isbtnshow" @click="goVideo" type="success">提交所有分数</el-button>
  </div>
</template>
<script>
import appheader from './AppHeader'
const musicList = [
  '../../static/audio/piano.mp3',
  '../../static/audio/豹子叫声.mp3'
]
export default {
  name: 'Audio',
  data() {
  ...
  methods: {
    ...
    goVideo() {
      ...
      fetch('http://120.79.193.101:8080/ApproximateComputing/audio/audios', {
        method: 'post',
        headers: {
